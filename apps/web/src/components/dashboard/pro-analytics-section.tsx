...
import { BarChart3, Crown, Lock, Sparkles } from 'lucide-react';
...
export interface ProAnalyticsSectionProps {
  ...
  plan: PlanType;
  /** Top selling products (only used if PRO) */
  topProducts?: TopSellingProduct[];
  /** Project breakdown data (only used if PRO) */
 ...
 * ProAnalyticsSection
 *
 * Displays advanced analytics for PRO subscribers.
 * Shows an upgrade prompt for FREE plan users.
 *
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center rounded-lg bg-white/80 backdrop-blur-sm">
              ...
              <p className="mb-4 max-w-sm text-center text-sm text-muted-foreground">
                Passez a PRO pour acceder aux statistiques detaillees de vos
