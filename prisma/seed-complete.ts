...
const CREATORS_DATA: CreatorDef[] = [
  {
    id: 'hugo_tessier',
    ...
    stripeAccountId: 'acct_demo_hugo_tessier',
    brandStyle: 'Streetwear minimaliste parisien, influences architecturales, coupes oversize',
    niche: 'streetwear_masc',
    collections: [
      { name: 'Urban Core', desc: 'Essentiels du quotidien urbain, matières premium, coupes architecturales' },
      { name: 'Monochrome SS26', desc: 'Collection capsule tout-noir et tout-blanc, pureté des formes' },
      { name: 'Concrete City', desc: 'Inspirée du béton parisien, textures brutes et coupes nettes' },
      { name: 'Late Night Essential', desc: 'Pour les nuits parisiennes, loungewear élevé au rang d\'œuvre' },
      { name: 'Archive Series 01', desc: 'Réinterprétation des classiques streetwear des années 2000' },
    ],
  },
  {
    id: 'lea_fontaine',
    ...
    name: 'Léa Fontaine',
    brandName: 'Léa Fontaine Atelier',
    slug: 'lea-fontaine',
    phone: '+33623456789',
    ...
    stripeAccountId: 'acct_demo_lea_fontaine',
    brandStyle: 'Mode artisanale française, lin biologique, minimalisme provençal, éco-responsable',
    niche: 'artisanal_lin',
    collections: [
      { name: 'Matière Première', desc: 'L\'essence du lin brut, sublimé par des coupes épurées' },
      { name: 'Épure Printemps', desc: 'Légèreté absolue, fluidité naturelle, couleurs de la garrigue' },
      { name: 'Atelier No.3', desc: 'Pièces uniques issues de l\'atelier marseillais, lin de Loire' },
      { name: 'Saisons Douces', desc: 'La transition entre les saisons, textures superposées' },
      { name: 'Blanc Cassé', desc: 'Monochrome naturel, nuances de blanc, écru et ivoire' },
    ],
  },
  {
    id: 'kais_benali',
    ...
    stripeAccountId: 'acct_demo_kais_benali',
    brandStyle: 'Sportswear technique haut de gamme, performance et style, influence trail running',
    niche: 'sportswear_tech',
    collections: [
      { name: 'Trail Ready', desc: 'Performance maximale pour les trails alpins, look technique premium' },
      { name: 'Everyday Active', desc: 'Du sport au quotidien, du studio au café, sans compromis' },
      { name: 'Endurance Series', desc: 'Longue distance, tenues conçues pour les ultra-marathons' },
      { name: 'Court & Studio', desc: 'Tennis, yoga, crossfit — polyvalence et style affirmé' },
      { name: 'Winter Training', desc: 'Entraînement hivernal, couches techniques pour le froid' },
    ],
  },
  {
    id: 'marie_dubois',
    email: 'marie.dubois@kpsull.fr',
    name: 'Marie Dubois',
    brandName: 'Maison Dubois',
    slug: 'maison-dubois',
    phone: '+33645678901',
    ...
    stripeAccountId: 'acct_demo_marie_dubois',
    brandStyle: 'Haute couture française accessible, élégance parisienne, robes de soirée',
    niche: 'haute_couture_fem',
    collections: [
      { name: 'Soirée Parisienne', desc: 'Robes de soirée pour les grandes occasions parisiennes' },
      { name: 'Quotidien Élégant', desc: 'L\'élégance française au quotidien, pièces intemporelles' },
      { name: 'Capsule Couture', desc: 'Pièces signature de la Maison, construction couture' },
      { name: 'Été Côtier', desc: 'Légèreté et sophistication pour les étés méditerranéens' },
      { name: 'Automne Parisien', desc: 'Drapés profonds, matières nobles pour l\'automne parisien' },
    ],
  },
  {
    id: 'antoine_chen',
    email: 'antoine.chen@kpsull.fr',
    name: 'Antoine Chen',
    brandName: 'Chen Studio',
    slug: 'chen-studio',
    phone: '+33656789012',
    ...
    stripeAccountId: 'acct_demo_antoine_chen',
    brandStyle: 'Luxury streetwear franco-asiatique, graphisme bold, matières premium, éditions limitées',
    niche: 'streetwear_masc',
    collections: [
      { name: 'Premium Basics', desc: 'Les bases premium du luxury streetwear, coupes architecturales' },
      { name: 'Capsule Limitée', desc: 'Éditions ultra-limitées, numérotées et signées' },
      { name: 'Graphic Series', desc: 'Graphisme audacieux, imprimés sérigraphiés à la main' },
      { name: 'Heritage Reboot', desc: 'Réinterprétation premium des classiques sportswear' },
      { name: 'Future Archive', desc: 'Pièces collector, production limitée, futur vintage' },
    ],
  },
  {
    id: 'sofia_nakamura',
    email: 'sofia.nakamura@kpsull.fr',
    name: 'Sofia Nakamura',
    brandName: 'Sō Studio',
    slug: 'so-studio',
    phone: '+33667890123',
    ...
    stripeAccountId: 'acct_demo_sofia_nakamura',
    brandStyle: 'Minimalisme japonisant, wabi-sabi, impermanence, textures naturelles, Bordeaux',
    niche: 'minimaliste',
    collections: [
      { name: 'Ma — L\'Espace', desc: 'L\'espace vide comme élément de design, coupes aérées' },
      { name: 'Wabi-Sabi', desc: 'La beauté de l\'imperfection, matières brutes et précieuses' },
      { name: 'Shizen', desc: 'La nature comme inspiration, formes organiques' },
      { name: 'Sabi — Patine', desc: 'Le temps qui passe sublimé, pièces qui vieillissent bien' },
      { name: 'Mu — Le Vide', desc: 'Épure absolue, moins est plus, une seule matière' },
    ],
  },
  {
    id: 'karim_hadj',
    email: 'karim.hadj@kpsull.fr',
    name: 'Karim Hadj',
    brandName: 'Hadj Couture',
    slug: 'hadj-couture',
    phone: '+33678901234',
    address: '23 rue de la Goutte d\'Or',
    city: 'Paris',
    postalCode: '75018',
    plan: Plan.STUDIO,
    siret: '77777777777777',
    stripeAccountId: 'acct_demo_karim_hadj',
    brandStyle: 'Mode africaine contemporaine, wax et kente revisités, fusion culturelle parisienne',
    niche: 'culturel_mode',
    collections: [
      { name: 'Racines', desc: 'Hommage aux origines, tissus wax et kente contemporains' },
      { name: 'Fusion Parisienne', desc: 'Africa meets Paris, le meilleur des deux mondes' },
      { name: 'Cérémonie Moderne', desc: 'Tenues de cérémonie réinventées pour l\'homme moderne' },
      { name: 'Diaspora', desc: 'La diaspora africaine en France, identité plurielle' },
      { name: 'Couleurs de Dakar', desc: 'Palette vibrante inspirée du Sénégal, coupes contemporaines' },
    ],
  },
  {
    id: 'emma_vidal',
    email: 'emma.vidal@kpsull.fr',
    name: 'Emma Vidal',
    brandName: 'Vidal Éco',
    slug: 'vidal-eco',
    phone: '+33689012345',
    ...
    stripeAccountId: 'acct_demo_emma_vidal',
    brandStyle: 'Mode durable éco-responsable, matières naturelles, slow fashion lyonnaise',
    niche: 'artisanal_lin',
    collections: [
      { name: 'Herbe & Terre', desc: 'Fibres végétales certifiées, teintures naturelles' },
      { name: 'Eau Claire', desc: 'Production zéro eau, lin et chanvre biologiques' },
      { name: 'Air Libre', desc: 'Légèreté maximale, fibres aériennes, coupes amples' },
      { name: 'Feu Doux', desc: 'Chaleur naturelle, laines recyclées, hiver durable' },
      { name: 'Cycle Perpétuel', desc: 'Mode circulaire, matières 100% biodégradables' },
    ],
  },
  {
    id: 'paul_mercier',
    email: 'paul.mercier@kpsull.fr',
    name: 'Paul Mercier',
    brandName: 'Mercier Tailoring',
    slug: 'mercier-tailoring',
    phone: '+33690123456',
    ...
    stripeAccountId: 'acct_demo_paul_mercier',
    brandStyle: 'Tailleur masculin classique français, sur-mesure accessible, élégance intemporelle',
    niche: 'tailleur_masc',
    collections: [
      { name: 'Classique Parisien', desc: 'Le tailleur parisien par excellence, coupes raffinées' },
      { name: 'Business Élégant', desc: 'Pour le monde professionnel, classe et confort' },
      { name: 'Soirée & Gala', desc: 'Tenues de gala, smokings et ensembles de soirée' },
      { name: 'Weekend Chic', desc: 'L\'élégance décontractée du weekend, blazers et pantalons' },
      { name: 'Capsule Travail', desc: 'Capsule professionnelle complète pour la semaine' },
    ],
  },
  {
    id: 'yasmine_larbi',
    ...
    slug: 'yasmine-bijoux',
    phone: '+33601234567',
    address: '8 rue de la Buffa',
    city: 'Nice',
    postalCode: '06000',
    plan: Plan.ESSENTIEL,
    siret: '10101010101010',
    stripeAccountId: 'acct_demo_yasmine_larbi',
    brandStyle: 'Bijoux artisanaux français, influences méditerranéennes, laiton doré et pierres naturelles',
    niche: 'bijoux_artisanal',
    collections: [
      { name: 'Minéral Azur', desc: 'Pierres semi-précieuses de Méditerranée, laiton doré' },
      { name: 'Corail & Or', desc: 'Inspiré des fonds marins niçois, palette chaude' },
      { name: 'Végétal Doré', desc: 'Formes organiques inspirées de la botanique méditerranéenne' },
      { name: 'Architectures', desc: 'Géométrie pure, lignes nettes, modernité intemporelle' },
      { name: 'Été Éternel', desc: 'Pour ne jamais quitter l\'été niçois, légèreté et éclat' },
    ],
  },
  {
    id: 'louis_renard',
    ...
    slug: 'renard-outerwear',
    phone: '+33612345679',
    address: '4 place Gutenberg',
    city: 'Strasbourg',
    postalCode: '67000',
    plan: Plan.STUDIO,
    siret: '11111111111112',
    stripeAccountId: 'acct_demo_louis_renard',
    brandStyle: 'Outerwear premium alsacien, laines et cachemires nobles, protection élégante contre le froid',
    niche: 'outerwear',
    collections: [
      { name: 'Hiver Alsacien', desc: 'Protection maximale contre le froid strasbourgeois, style intact' },
      { name: 'Automne Doré', desc: 'Transition saison, couches nobles et vestes structurées' },
      { name: 'Voyage Polaire', desc: 'Pour les conditions extrêmes, performance et élégance' },
      { name: 'City Classic', desc: 'L\'outerwear urbain raffiné, entre ville et campagne' },
      { name: 'Capsule Trench', desc: 'Réinterprétation du trench classique, coupes contemporaines' },
    ],
  },
  {
    id: 'nadia_forte',
    ...
    postalCode: '75002',
    plan: Plan.STUDIO,
    siret: '22222222222223',
    stripeAccountId: 'acct_demo_nadia_forte',
    brandStyle: 'Lingerie fine artisanale française, dentelle de Calais, satin et broderie, féminité assumée',
    niche: 'lingerie_fine',
    collections: [
      { name: 'Dentelle de Calais', desc: 'Dentelle authentique de Calais, fabrication française' },
      { name: 'Satin Parisien', desc: 'Satins glissés, nuisettes et déshabillés de luxe' },
      { name: 'Coton Brodé', desc: 'Coton doux et broderies délicates, confort et élégance' },
      { name: 'Nuit de Noces', desc: 'Collections spéciales mariée, raffinement absolu' },
      { name: 'Everyday Luxe', desc: 'Luxe quotidien, confort premium, belles matières' },
    ],
  },
  {
    id: 'baptiste_moreau',
    email: 'baptiste.moreau@kpsull.fr',
    name: 'Baptiste Moreau',
    brandName: 'Moreau Denim',
    slug: 'moreau-denim',
    phone: '+33634567891',
    ...
    postalCode: '31000',
    plan: Plan.STUDIO,
    siret: '33333333333334',
    stripeAccountId: 'acct_demo_baptiste_moreau',
    brandStyle: 'Denim artisanal selvedge, production artisanale française, jean over-dye et fades naturels',
    niche: 'denim_artisanal',
    collections: [
      { name: 'Raw Denim No.1', desc: 'Selvedge brut japonais, fades naturels au fil du temps' },
      { name: 'Stone Washed', desc: 'Lavage et délavages artisanaux, chaque pièce unique' },
      { name: 'Selvedge Archive', desc: 'Tissages selvedge rares, éditions très limitées' },
      { name: 'Workwear Heritage', desc: 'L\'héritage du workwear américain réinterprété à Toulouse' },
      { name: 'Colored Denim', desc: 'Teintures naturelles sur denim, couleurs inattendues' },
    ],
  },
  {
    id: 'camille_petit',
    ...
    slug: 'studio-camille',
    phone: '+33645678902',
    address: '3 rue Sainte-Catherine',
    city: 'Bordeaux',
    postalCode: '33100',
    plan: Plan.STUDIO,
    siret: '44444444444445',
    stripeAccountId: 'acct_demo_camille_petit',
    brandStyle: 'Mode féminine romantique bordelaise, robes fleuries, dentelles et broderies, garden party',
    niche: 'romantique_fem',
    collections: [
      { name: 'Jardin Secret', desc: 'Fleurs et romantisme, robes pour les jardins bordelais' },
      { name: 'Printemps Gironde', desc: 'La légèreté du printemps, imprimés botaniques' },
      { name: 'Soirée Rosé', desc: 'Pour les soirées estivales, élégance décontractée' },
      { name: 'Promenade Côtière', desc: 'Bord de mer et dunes, légèreté balnéaire' },
      { name: 'Automne Romantique', desc: 'Transition vers l\'automne, tons dorés et broderies' },
    ],
  },
  {
    id: 'rayan_diop',
    email: 'rayan.diop@kpsull.fr',
    name: 'Rayan Diop',
    brandName: 'RD Custom',
    slug: 'rd-custom',
    phone: '+33656789013',
    ...
    postalCode: '75019',
    plan: Plan.STUDIO,
    siret: '55555555555556',
    stripeAccountId: 'acct_demo_rayan_diop',
    brandStyle: 'Sneakers custom art, peinture acrylique sur cuir, streetwear parisien, culture sneaker',
    niche: 'sneaker_custom',
    collections: [
      { name: 'Air Custom Series', desc: 'Customs sur base Air Max, art urbain parisien' },
      { name: 'Jordan Artworks', desc: 'Customs Jordan, éditions numérotées, collectors' },
      { name: 'Classic Remixed', desc: 'Classiques du sneaker revisités avec une touche artistique' },
      { name: 'Limited Drops', desc: 'Drops ultra-limités, 5 paires max, chaque paire unique' },
      { name: 'Archive Customs', desc: 'Pièces archivées, les premiers customs de l\'atelier' },
    ],
  },
  {
    id: 'julie_martin',
    email: 'julie.martin@kpsull.fr',
    name: 'Julie Martin',
    brandName: 'Julie Knit',
    slug: 'julie-knit',
    phone: '+33667890124',
    ...
    postalCode: '69002',
    plan: Plan.ESSENTIEL,
    siret: '66666666666667',
    stripeAccountId: 'acct_demo_julie_martin',
    brandStyle: 'Knitwear artisanal lyonnais, mérinos et alpaga, points traditionnels revisités',
    niche: 'knitwear',
    collections: [
      { name: 'Laine de Lyon', desc: 'Tribute à la tradition soyeuse lyonnaise, knitwear premium' },
      { name: 'Automne Alpin', desc: 'Inspirée des Alpes, laines robustes et douces' },
      { name: 'Printemps Knitwear', desc: 'Tricots légers pour la transition, cotons et soies' },
      { name: 'Hiver Nordique', desc: 'Pulls chauds, inspirations islandaises et norvégiennes' },
      { name: 'Capsule Cachemire', desc: 'Le luxe du cachemire, pièces d\'exception' },
    ],
  },
  {
    id: 'theo_bernard',
    email: 'theo.bernard@kpsull.fr',
    name: 'Théo Bernard',
    brandName: 'TB Fluid',
    slug: 'tb-fluid',
    phone: '+33678901235',
    address: '28 rue du Fbg Saint-Antoine',
    city: 'Paris',
    postalCode: '75010',
    plan: Plan.STUDIO,
    siret: '77777777777778',
    stripeAccountId: 'acct_demo_theo_bernard',
    brandStyle: 'Mode gender-fluid contemporaine, coupes androgynes, fluidité des genres, Paris 2026',
    niche: 'romantique_fem',
    collections: [
      { name: 'Sans Genre', desc: 'Pièces libres de tout genre, pour toutes et tous' },
      { name: 'Fluidité', desc: 'Coupes fluides qui traversent les genres avec grâce' },
      { name: 'Bold & Soft', desc: 'Dualité assumée, forte structure et matières douces' },
      { name: 'Structure Libre', desc: 'Architecture vestimentaire sans frontières de genre' },
      { name: 'Neutre Absolu', desc: 'Neutralité parfaite, couleurs et coupes universelles' },
    ],
  },
  {
    id: 'sarah_cohen',
    email: 'sarah.cohen@kpsull.fr',
    name: 'Sarah Cohen',
    brandName: 'Vintage by Sarah',
    slug: 'vintage-sarah',
    phone: '+33689012346',
    address: '44 rue de la Canebière',
    city: 'Marseille',
    postalCode: '13001',
    plan: Plan.ESSENTIEL,
    siret: '88888888888889',
    stripeAccountId: 'acct_demo_sarah_cohen',
    brandStyle: 'Mode vintage revisitée marseillaise, influence méditerranéenne, 70s-90s réinterprétées',
    niche: 'vintage_reviste',
    collections: [
      { name: 'Seventies Revival', desc: 'Flares, velours et couleurs chaudes des seventies' },
      { name: 'Eighties Bold', desc: 'Épaulettes et graphisme des 80s revisités avec goût' },
      { name: 'Nineties Marseille', desc: 'Le style 90s à la sauce marseillaise' },
      { name: '2000s Nostalgie', desc: 'Y2K revisité, mini-robes et denim bas de gamme' },
      { name: 'Intemporel Méditerranéen', desc: 'Pièces intemporelles aux influences méditerranéennes' },
    ],
  },
  {
    id: 'nicolas_roy',
    email: 'nicolas.roy@kpsull.fr',
    name: 'Nicolas Roy',
    brandName: 'Roy Workwear',
    slug: 'roy-workwear',
    phone: '+33601234568',
    address: '11 av. de Suffren',
    city: 'Paris',
    postalCode: '75015',
    plan: Plan.STUDIO,
    siret: '99999999999990',
    stripeAccountId: 'acct_demo_nicolas_roy',
    brandStyle: 'Mode professionnelle chic parisienne, blazers structurés, entre bureau et soirée',
    niche: 'tailleur_masc',
    collections: [
      { name: 'Bureau 2026', desc: 'Le nouveau workwear chic, pour les bureaux modernes' },
      { name: 'Meeting Premium', desc: 'Tenues de réunion premium, autorité naturelle' },
      { name: 'After Work', desc: 'Du bureau à la soirée sans se changer' },
      { name: 'Vendredi Casual', desc: 'Smart casual pour le vendredi, décontracté et chic' },
      { name: 'Capsule Executive', desc: 'Les 10 pièces essentielles de l\'executive parisien' },
    ],
  },
  {
    id: 'amira_benali',
    email: 'amira.benali@kpsull.fr',
    name: 'Amira Benali',
    brandName: 'Amira Mode',
    slug: 'amira-mode',
    phone: '+33612345680',
    ...
    stripeAccountId: 'acct_demo_amira_benali',
    brandStyle: 'Mode orientale contemporaine, caftans brodés, djellabas modernes, fusion franco-maghrébine',
    niche: 'culturel_mode',
    collections: [
      { name: 'Caftan Moderne', desc: 'Le caftan marocain réinventé pour la femme contemporaine' },
      { name: 'Orient Express', desc: 'Fusion Orient-Occident, broderies traditionnelles coupes modernes' },
      { name: 'Soirée Maghreb', desc: 'Tenues de fête maghrébines dans un esprit contemporain' },
      { name: 'Quotidien Oriental', desc: 'Mode orientale pour le quotidien lillois et parisien' },
      { name: 'Hiver Doré', desc: 'Collections hivernales brodées or et argent, richesse textile' },
    ],
  },
];
